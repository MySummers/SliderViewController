...
-(void)setupTitle{
    ...
    if (self.titleScrollView.contentSize.width/self.titlesArr.count < 80) {
        self.lineView = [[UIView alloc] initWithFrame:CGRectMake(20, titleH - 2, 40, 2)];
    }else{
        self.lineView = [[UIView alloc] initWithFrame:CGRectMake(20, titleH - 2, self.titleScrollView.contentSize.width/self.titlesArr.count/2, 2)];
    }
